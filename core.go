...
func NewPointVectorFromMat(mat Mat) PointVector {
	return PointVector{p: C.PointVector_NewFromMat(mat.Ptr())}
}
...
func NewPoint2fVectorFromMat(mat Mat) Point2fVector {
	return Point2fVector{p: C.Point2fVector_NewFromMat(mat.Ptr())}
}
...
func NewPoint3fVectorFromMat(mat Mat) Point3fVector {
	return Point3fVector{p: C.Point3fVector_NewFromMat(mat.Ptr())}
}
